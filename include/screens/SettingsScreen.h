...
#define SETTINGS_MENU_ITEMS_COUNT        5

#define SETTINGS_MENU_ITEM_CONNECTION    1
#define SETTINGS_MENU_ITEM_UPDATE        2
#define SETTINGS_MENU_ITEM_TEST          3
#define SETTINGS_MENU_ITEM_BACK          4
...
class SettingsScreen : public Screen {    
    private:
        ...
        int minMenuItem = 1;
        int maxMenuItem = SETTINGS_MENU_ITEMS_COUNT - 1;

        const char* menuItems[SETTINGS_MENU_ITEMS_COUNT] = {
            "Настройки:", // нельзя выбрать
            "Подкл-е",
            "Обновление",
            "Тест",
            "Назад",
    ...
    public:
        ...
        void reset() override {
            ...
            activeMenuItem = 1;
            minMenuItem = 1;
            maxMenuItem = SETTINGS_MENU_ITEMS_COUNT - 1;
            line1.setText(menuItems[0]);
            line2.setText(menuItems[1]);
        ...
        void onEncoderButtonClick() override {
            switch (activeMenuItem) {
                // case SETTINGS_MENU_ITEM_CONNECTION:
                //     gotoRecipesScreen();
                //     break;
                case SETTINGS_MENU_ITEM_UPDATE:
                    gotoUpdateFirmwareScreen();
                    break;
                case SETTINGS_MENU_ITEM_TEST:
                    gotoTestScreen();
                    break;
